  ...
  public void unpackTo(RpcMessageHeaderT _o) {
    ...
    switch (_oMessageType) {
      ...
      case solarxr_protocol.rpc.RpcMessage.ForgetDeviceRequest:
        ...
        break;
      case solarxr_protocol.rpc.RpcMessage.SerialTrackerCommandRequest:
        _oMessageValue = message(new solarxr_protocol.rpc.SerialTrackerCommandRequest());
        _oMessage.setValue(_oMessageValue != null ? ((solarxr_protocol.rpc.SerialTrackerCommandRequest) _oMessageValue).unpack() : null);
        break;
      default: break;
    }
